...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pdfcrop.pl-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14969&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pdfcrop.pl-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pdfcrop.pl` can be installed with:

```
conda install pdfcrop.pl
```

It is possible to list all of the versions of `pdfcrop.pl` available on your platform with:
